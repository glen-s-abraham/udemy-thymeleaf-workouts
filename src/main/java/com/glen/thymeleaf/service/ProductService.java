package com.glen.thymeleaf.service;
...
import com.glen.thymeleaf.pojo.*;
...
public class ProductService {
    ...
    private void loadProducts() {
        ...
        springIntroCat.setCategoryName("Spring Introduction");

        Category springCoreCat = new Category();
        springCoreCat.setId(2);
        springCoreCat.setCategoryName("Spring Core");

        Category springBootCat = new Category();
        springBootCat.setId(3);
        springBootCat.setCategoryName("Spring Boot");

        Category thymeleafCat = new Category();
        thymeleafCat.setId(4);
        thymeleafCat.setCategoryName("Thymeleaf");

        Category geapCat = new Category();
        geapCat.setId(5);
        geapCat.setCategoryName("G.E.A.P");
